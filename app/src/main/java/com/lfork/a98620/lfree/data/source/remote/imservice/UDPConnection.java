...
//
//import data.remote.service.message.Message;
//import data.remote.service.message.MessageHelper;
//import data.remote.service.message.MessageType;
//
...
//            System.out.println("UDPConnection.startReceiveListener(): 接收到的信息：" + message);
...
//                    }
//                    // 300秒就保活一次
//                    System.out.println("UDPConnection.keepAlive():保活消息已发送(30秒一次)");
//                    try {
